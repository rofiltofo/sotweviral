...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepsotweviral.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepsotweviral.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bokepsotweviral.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
